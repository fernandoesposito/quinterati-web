export const supportText = {
  ...
  <div className="font-roboto leading-6 text-support max-md:text-sm">
    <h2 className="uppercase">TERMO DE USO E OUTRAS AVENÇAS</h2>
    <br/>
    <p>Estes termos e condições descrevem as regras de uso do site da empresa Quintara, localizado no endereço quintera.com.br.<br/>
      Ao acessar este site, consideramos que você está de acordo com os termos e condições abaixo. Não continue a usar o Quintera caso você discorde dos termos e condições descritos neste contrato.<br/><br/>
    </p>
    <h3>Cookies:</h3>
    <br/>
    <p>O site usa cookies para ajudar na personalização da sua experiência na internet. Ao acessar o site uxnocode, você concorda com o uso dos cookies requeridos.<br/>
    Cookies são arquivos de texto inseridos no seu disco rígido por um servidor de página web. Os cookies não têm permissão para executar programas ou transferir vírus para seu computador. Os cookies são associados exclusivamente a você e só podem ser lidos pelo servidor web do domínio que emitiu o cookie.<br/><br/>
    ...
    <h3>Licença:</h3><br/>
    <p>Exceto em casos em que for indicado o contrário, Quintera e seus licenciados têm direito à propriedade intelectual de todo o material postado no quintera.com.br. Todos os direitos à propriedade intelectual são reservados.<br/><br/>
    Você não tem permissão para:
    </p>
    <ul>
      <li>Copiar ou republicar materiais do quintera.com.br.</li>
      <li>Vender, alugar ou sublocar materiais do quintera.com.br.</li>  
      <li>Reproduzir, duplicar ou copiar materiais do quintera.com.br.</li> 
    </ul>
    <br/><br/>
    <p>Redistribuir conteúdos do quintera.com.br<br/><br/>
    Este Acordo terá efeito a partir da data presente.<br/>
    Partes deste site oferecem ao usuário a oportunidade de postar e discutir opiniões e informações em determinadas áreas. uxnocode não filtra, edita, publica ou revisa Comentários antes que eles sejam apresentados no site. Comentários refletem as opiniões da pessoa que os posta. Na extensão em que as leis aplicáveis permitem, uxnocode não se responsabiliza legalmente pelos Comentários ou quaisquer danos, riscos ou despesas causadas ou sofridas como resultado do uso, e/ou postagem e/ou aparência dos Comentários deste site.
    <br/><br/>
    Quintera reserva para si o direito de remover quaisquer Comentários que possam ser considerados inapropriados, ofensivos ou quebrem os Termos e Condições deste contrato.
    <br/><br/>
    Você declara e garante que:</p>
    <ul>
      ...
      <li>Você por meio deste concede a uxnocode a licença não-exclusiva de usar, reproduzir, editar e autorizar outros a usar, reproduzir ou editar qualquer um de seus Comentários em qualquer e todas as formas, formatos e mídias.</li>
    </ul>
      <br/><br/>
      <p>Criação de links para nosso conteúdo
      <br/><br/>
      ...
      <ul>
        ...
        <li>Distribuidores de diretórios online podem inserir links para nosso Site na mesma maneira que inserem hiperlinks para Sites de outras empresas listadas; e Empresas credenciadas, exceto organizações angariantes sem fins lucrativos e grupos de arrecadação de fundos para instituições de caridade, que não podem inserir links para nosso Site sem aprovação prévia.</li>  
      </ul>
      <br/>
      <br/>
      ...
      <br/>
      <br/>
      Nós podemos considerar e aprovar solicitações de link feitas pelos seguintes tipos de organizações:</p>
      <ul>
      ...
      <br/>
      <br/>
      Se você representa uma das organizações listadas no parágrafo 2 acima e está interessado em postar um link para nosso site, você deve nos informar de seu interesse enviando um e-mail para uxnocode. Por favor, inclua seu some, o nome da sua organização e suas informações de contato, assim como a URL do seu site, uma lista das URLs do nosso site que você pretende usar como links, e uma lista dos sites nos quais você pretende publicar nossas URLs. Aguarde entre 2 e 3 semanas para receber uma resposta.
      <br/>
      Organizações aprovadas poderão publicar links para nosso Site das seguintes formas:</p>
      <ul>
        ...
        <li>Não será permitido o uso ou a publicação de links para o logo e/ou outros elementos visuais da uxnocode sem um acordo de licença para o uso da marca registrada.</li>
      </ul>
      <br/>
      <br/>
      ...
      <br/>
      <br/>
      Nós não garantimos que as informações continas neste site são corretas. Nós não garantimos integralidade ou exatidão do conteúdo. Não garantimos que o site se manterá disponível ou que o material do site se manterá atualizado.</p>
      <br/>
      <br/>
      ...
      <br/>
      <p>As limitações e proibições de responsabilização listadas nesta Seção e em outras partes desta declaração: (a) estão sujeitas ao parágrafo anterior; e (b) regem todas as responsabilizações que surgirem sob a declaração, incluindo responsabilizações surgidas em contrato, em delitos e em quebra de obrigações legais.
      <br/>
      <br/>
