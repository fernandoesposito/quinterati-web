export const supportText = {
  ...
  <div className="font-roboto leading-6 text-support max-md:text-sm">
    <p>A sua privacidade é importante para nós. É política da Quintera respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site quintera.com.br, e outros sites que possuímos e operamos.
    <br/>
    <br/>
    ...
    <br/>
    O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o uxnocode oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <br/>
  <ul className="list-disc px-4">
    ...
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do uxnocode, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
  </ul>
  <br/>
  <br/>
  <p>Mais informações
    ...
    <br/>
    <br/>
    Esta política é efetiva a partir de fevereiro de 2024.</p>
  </div>
}