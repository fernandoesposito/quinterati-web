...
export default function Intro() {
  ...
  return (
    <>
      ...
      <MobileNavbar />
      <section className="w-screen bg-main lg:px-[4.5rem] px-6 md:pt-[calc(5rem+78px)] pt-[calc(50px+1.5rem)] flex flex-col">
        <div className="md:grid md:grid-cols-2 gap-12 place-self-center"> {/*review gap-12 -> lower it?*/}
          ...
          <div className="max-w-xl flex flex-col gap-6 place-items-center md:place-items-start">
            ...
            <div className="w-fit flex flex-col gap-2 md:gap-6 place-items-center md:place-items-start">
              ...
              <span className="md:text-subtitle text-gray-500 font-normal font-inter text-md md:text-left text-center leading-4 md:max-w-none max-w-72">
      ...
      <section id="beneficios" className="w-screen bg-main lg:px-44 px-6 md:pb-16 pb-7 flex flex-col md:gap-8 gap-2 items-center justify-center">
        ...
        <div className="md:grid md:grid-cols-2 md:gap-[4.5rem] flex flex-col gap-6">
          <div className="md:w-96 md:p-10 p-7 flex flex-col items-center rounded-2xl border border-gray-300">
            <Image src={quintera_logo} alt="quinterati logo" className="ml-auto mr-auto"/>
            <summary className="list-none md:mt-2 mt-4 md:mb-5 mb-8 text-center md:text-left text-gray-500 font-inter font-medium text-md leading-5">
      ...
      <section className="w-screen md:bg-white bg-gray-700 md:px-28 px-6 md:pt-12 py-8 md:pb-4 flex flex-col gap-12 items-center">
        <div className="flex flex-col items-center justify-center gap-4 md:py-6 md:bg-main md:border w-full md:border-gray-300 md:rounded-2xl md:shadow-md md:shadow-black-[.1]">
          ...
          <div className="flex flex-col gap-2 justify-center items-center">
            ...
            <summary className="list-none font-inter font-medium text-center text-md md:max-w-md text-support leading-5 max-w-80">
      ...
      <section id="contato" className="w-screen bg-white flex flex-col md:pb-4 md:pt-8 pt-6 items-center md:px-36 px-8">
        ...
        <h3 className="font-black font-roboto md:text-header text-lg leading-6 md:leading-10 text-center text-primary max-md:max-w-64 md:mb-12 md:mt-4 mt-2 mb-3">
          Precisa de um contato personalizado?
        </h3>
      ...
      <section className="w-screen bg-white md:pb-10 py-10 lg:px-36 px-11 flex flex-col items-center md:gap-10">
        ...
        <h3 className="font-black font-roboto md:text-header text-lg max-md:max-w-64 leading-6 md:leading-10 max-md:mt-2 max-md:mb-6 text-center text-primary">
          Veja algumas perguntas frequentes sobre:
        </h3>
