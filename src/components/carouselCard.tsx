...
export const CarouselCard: React.FC<CarouselPropsExtended> = ({ img, header, topic, content, alt="", ...rest }: CarouselProps) => {
  return (
    <div className="flex flex-col items-center gap-8 bg-white p-6 rounded-lg ml-4 h-full" {...rest}>
      ...
      <div className="flex flex-col gap-3 font-roboto overflow-hidden">
        ...
        <p className="text-gray-600 text-sm after:content-['Ver_mais'] after:text-secondary">{content}</p>
      </div>
    </div>
  )
}